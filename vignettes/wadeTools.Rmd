...
# Out of the 198k events in the original file, 109k are inside the blob boundary
```
...
# note that the number of gated events rose from 109k to 125k due to the fact

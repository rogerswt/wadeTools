...
ggflow(ff1, params = c("CD3Q605","CD4PETR")) + ggtitle("Default Transformation")  + theme(plot.title = element_text(size = 10))
ggflow(ff2, params = c("CD3Q605","CD4PETR"), trans_fl = "asinh") + ggtitle("asinh Transformation w/ cofactor = 5") + theme(plot.title = element_text(size = 10))
ggflow(ff3, params = c("CD3Q605","CD4PETR"), trans_fl = 'log') + ggtitle("Log Transformation") + theme(plot.title = element_text(size = 10))
ggflow(ff4, params = c("CD3Q605","CD4PETR"), trans_fl = 'asinh', cofactor = 100) + ggtitle("asinh Transformation w/ cofactor = 100") + theme(plot.title = element_text(size = 10))
```
